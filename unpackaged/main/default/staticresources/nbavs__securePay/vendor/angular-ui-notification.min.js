		...
		var notify = function(args, t){
			...
			$http.get(args.template,{cache: $templateCache}).success(function(template) {
				...
				if (args.hasOwnProperty('message')) {
					//fix multiple apex messages
					args.message = args.message.replace(/###/g, '<br>').replace(/\n/g,"<br>");
					scope.message = $sce.trustAsHtml(args.message);
				} else if (args.hasOwnProperty('data')) {
					scope.message = $sce.trustAsHtml(args.data[0].errorCode + ' : ' + args.data[0].message.replace(/###/g, '<br>').replace(/\n/g,"<br>"));
				}
